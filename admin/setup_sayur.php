...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE nama LIKE '%sayur%'"));
...
$tb_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%sayur%' LIMIT $awalData, $jumlahDataPerHalaman");
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							<li>
								<i style="padding-right: 10px"></i>Sayuran
							</li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading"><h3>Sayuran</h3></div>
							<div class="panel-body">
								<center><h2 style="color: red;">Produk Sayur</h2></center><br>
