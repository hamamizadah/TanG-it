...
$jumlahData = count(query("SELECT * FROM tbl_barang WHERE nama LIKE '%rempah%'"));
...
$tb_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%rempah%' LIMIT $awalData, $jumlahDataPerHalaman");
