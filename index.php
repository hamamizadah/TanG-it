...
$gambar = query("SELECT gambar FROM tbl_barang ");
        ...
        <div class="col-md-4">
          <div class="span4">
            <div class="icons-box">
              ...
              <img src="<?php echo $row['gambar']; ?>" width="200px" height="180px" />
              <div class="product-label">
                <span class="new">BARU</span>
              </div>
              <div>
                <h4 class="product-price" style="margin-top: 10px;">Rp.<?php echo number_format($row['harga']); ?></h4>
              </div>
              ...
              <div class="clear"><a href="detailproduk.php?kd=<?php echo $row['id']; ?>" class="btn btn-md btn-warning">Detail</a>
                <a href="detailproduk.php?kd=<?php echo $row['id']; ?>" class="btn btn-md btn-info">Beli &raquo;</a>
              </div>
