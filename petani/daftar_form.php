        ...
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-primary">
              <div class="panel-heading"><h4 class="text-center"><i class="fa fa-user" style="padding-right: 10px"></i>Daftar Petani</h4></div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input class="form-control" name="telepon" type="text" value="" minlength="11" required="">
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="btn-group btn-group-justified">
                          <div class="btn-group">
                            <button type="submit" class="btn btn-primary" name="register2">Daftar</button>
                          </div>
                        </div>
                      </div>
